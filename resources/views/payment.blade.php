                            ...
                            <table class="table">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Amount Paid</th>
                                        <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Loan Amount</th>
                                        <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Loan Balance</th> 
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($payments as $payment)
                                    <tr>
                                        <td class="border-b whitespace-no-wrap">{{$payment->created_at}}</td>
                                        <td class="border-b whitespace-no-wrap">${{$payment->amount}}</td>
                                        <td class="border-b whitespace-no-wrap">${{$payment->loan->amount}}</td>
                                        <td class="border-b whitespace-no-wrap">${{$payment->loan->balance}}</td>                                        
                                        <td class="border-b whitespace-no-wrap">
                                            <a class="flex items-center mr-3" href="javascript:;"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> View </a>
                                        </td>
                                    </tr>   
                                    @endforeach                                 
                                </tbody>
