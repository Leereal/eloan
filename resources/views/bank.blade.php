<x-app-layout>
    <div class="intro-y flex items-center h-10">
        ...
        <a href="/banks" class="ml-auto flex text-theme-1 dark:text-theme-10"> <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> Reload Data </a>
    </div>
                    ...
                    <div class="preview">
                        <div class="overflow-x-auto">
                            <table class="table">
                                <thead>
                                    <tr>                                       
                                        <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Payment Method Name</th>
                                        <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Account Number</th>                                        
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($banks as $bank)
                                    <tr>
                                        <td class="border-b whitespace-no-wrap">{{$bank->name}}</td>
                                        <td class="border-b whitespace-no-wrap">{{$bank->account_number}}</td>                                      
                                    </tr>   
                                    @endforeach                                 
                                </tbody>
                            </table>
