<x-app-layout>
    <div class="intro-y flex items-center h-10">
        <h2 class="text-lg font-medium truncate mr-5">
            Balance is <span @if($loan->balance + 0 == 0) class="text-red-800" @endif>${{$loan->balance}}</span>
        </h2>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b whitespace-no-wrap">${{$payment->amount + 0}}</td>
                                        <td class="border-b whitespace-no-wrap">${{$payment->loan->amount +0 }}</td>
                                        <td class="border-b whitespace-no-wrap">${{$payment->loan->balance + 0}}</td> 
                                    </tr>   
                                    @endforeach                                 
                                </tbody>
                            </table>
